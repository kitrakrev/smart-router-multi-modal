...
SPECIALTY_QUERIES = {
    "medical.cardiology": [
        "Patient with ST elevation in leads II, III, aVF — diagnosis?",
        "Management of atrial fibrillation with rapid ventricular response",
        "Echocardiogram shows reduced ejection fraction of 30%",
        "ECG interpretation: prolonged QT interval in young athlete",
        "Heart failure with preserved ejection fraction treatment options",
        "Acute pericarditis vs myocardial infarction differential",
        "Aortic stenosis grading criteria and surgical indications",
        "Infective endocarditis Duke criteria assessment",
        "Hypertrophic cardiomyopathy screening in athletes",
        "Cardiac tamponade clinical presentation and management",
        "Beta blocker selection for heart failure with reduced EF",
        "Anticoagulation strategy for mechanical valve replacement",
        "Stress test interpretation with ST depression",
        "Wolff-Parkinson-White syndrome management",
        "Cardiac resynchronization therapy indications",
        "Pulmonary hypertension classification and treatment",
        "Post-MI rehabilitation guidelines",
        "Diastolic dysfunction grading by echo parameters",
        "Brugada syndrome risk stratification",
        "Myocarditis diagnosis and monitoring protocol",
        "Ventricular tachycardia ablation candidacy",
        "Coronary artery calcium score interpretation",
        "Patent foramen ovale closure indications",
        "Right heart catheterization interpretation",
        "Cardiac MRI findings in arrhythmogenic right ventricular cardiomyopathy",
    ],
    "medical.radiology": [
    ...
    "medical.ophthalmology": [
        "Diabetic retinopathy grading from fundus photograph",
        "Glaucoma assessment with elevated IOP and cup-to-disc ratio",
        "Age-related macular degeneration wet vs dry classification",
        "Retinal detachment signs and urgent management",
        "OCT interpretation showing macular edema",
        "Papilledema evaluation and workup for raised ICP",
        "Acute angle closure glaucoma emergency management",
        "Central retinal artery occlusion presentation",
        "Optic neuritis workup for multiple sclerosis",
        "Uveitis classification and systemic workup",
        "Cataract surgery IOL power calculation",
        "Retinopathy of prematurity screening protocol",
        "Corneal ulcer management with culture results",
        "Thyroid eye disease severity assessment",
        "Visual field defect localization and interpretation",
        "Pterygium surgical indications",
        "Ocular melanoma staging and management",
        "Amblyopia treatment in pediatric patient",
        "Vitreous hemorrhage differential diagnosis",
        "Keratoconus management options",
        "Orbital cellulitis vs preseptal cellulitis",
        "Strabismus evaluation and surgical planning",
        "Retinal vein occlusion management",
        "Dry eye disease severity grading",
        "Endophthalmitis post-operative management",
    ],
    "medical.emergency": [
        "Unconscious patient no pulse — CPR and ACLS protocol",
        "Anaphylaxis management with respiratory distress",
        "Acute stroke evaluation within treatment window",
        "Major trauma — primary and secondary survey",
        "Tension pneumothorax immediate decompression",
        "Status epilepticus treatment algorithm",
        "Septic shock resuscitation bundle",
        "Acute GI bleeding hemodynamic management",
        "Pediatric fever with petechial rash — meningococcemia?",
        "Diabetic ketoacidosis emergency management",
        "Burns assessment rule of nines and fluid resuscitation",
        "Acute coronary syndrome triage and treatment",
        "Hypertensive emergency management",
        "Overdose assessment and antidote selection",
        "Airway management in trauma with C-spine precautions",
        "Pulmonary embolism with hemodynamic instability",
        "Acute appendicitis vs other causes of RLQ pain",
        "Testicular torsion time-sensitive management",
        "Ectopic pregnancy with hemodynamic compromise",
        "Heat stroke vs heat exhaustion management",
        "Near drowning resuscitation protocol",
        "Snake bite management and antivenom indications",
        "Crush injury syndrome prevention and treatment",
        "Acute pancreatitis severity assessment",
        "Spinal cord injury acute management",
    ],
    "medical.pharmacology": [
        "Drug interaction between warfarin and ciprofloxacin",
        "Metformin dosing adjustment in renal impairment",
        "Lithium toxicity signs and management",
        "Antibiotic selection for community-acquired pneumonia",
        "Opioid equianalgesic conversion calculation",
        "Immunosuppressant drug monitoring post-transplant",
        "Antiepileptic drug selection for pregnant patient",
        "Contrast dye allergy premedication protocol",
        "Vancomycin dosing and trough level monitoring",
        "SSRI discontinuation syndrome management",
        "Heparin-induced thrombocytopenia alternative anticoagulation",
        "Statin-induced myopathy workup and management",
        "Chemotherapy dose reduction for hepatic impairment",
        "Digoxin toxicity ECG findings and treatment",
        "Drug interaction check for HIV antiretroviral regimen",
        "Insulin sliding scale vs basal-bolus regimen",
        "ACE inhibitor vs ARB selection in diabetic nephropathy",
        "Warfarin INR management for over-anticoagulation",
        "Antifungal selection for invasive aspergillosis",
        "Biologic therapy monitoring for rheumatoid arthritis",
        "Corticosteroid taper protocol for inflammatory conditions",
        "Antiplatelet therapy duration after stent placement",
        "Drug dosing in pediatric patient weight-based",
        "Pharmacogenomics CYP2D6 poor metabolizer implications",
        "Naloxone dosing for opioid reversal",
    ],
    "medical.general_medicine": [
        "Annual health screening recommendations for 50yo male",
        "Hypertension initial workup and lifestyle modifications",
        "Type 2 diabetes prevention strategies",
        "Obesity management pharmacotherapy options",
        ...
        "Hypothyroidism management and monitoring",
        "Chronic kidney disease staging and management",
        "Gout acute management and prophylaxis",
        "GERD management stepwise approach",
        "Asthma control assessment and step therapy",
        "COPD management GOLD guidelines",
        "Hepatitis C screening and treatment options",
        "Colorectal cancer screening guidelines",
        "Cervical cancer screening age-appropriate",
        "Vaccination schedule for immunocompromised adult",
        "Sleep apnea evaluation and CPAP management",
        "Chronic pain multimodal management approach",
        "Vitamin D deficiency treatment protocol",
        "Dyslipidemia management beyond statins",
        "Urinary tract infection recurrent prevention",
        "Irritable bowel syndrome management",
        "Migraine prophylaxis medication selection",
    ],
}
...
def generate_dataset(target_size: int = 5000) -> list[EvalSample]:
    ...
    vision_queries = [
        ...
        ("Grade this fundus photograph for diabetic retinopathy", "medical.ophthalmology"),
        ("CT scan axial slice showing abdominal mass", "medical.radiology"),
        ("ECG strip showing ST changes", "medical.cardiology"),
        ...
        ("OCT showing macular thickening", "medical.ophthalmology"),
    ...
    for i in range(critical_count):
        ...
        samples.append(EvalSample(
            ...
            expected_specialty="medical.emergency",
        ))
